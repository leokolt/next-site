...
const PostFooter = ({ text, title }) => {
    ...
    const postFooterShareClasses = [styles.postFooterShareItem, styles.postFooterShare, "mainBtn"].join(" ")
    ...
    return (
					...
					<div className={styles.postFooter}>
						<span>
                            <a className={postFooterShareTgClasses} href={`https://t.me/share/url?url=${url}&text=${title}`} target="_blank" rel="noreferrer">
